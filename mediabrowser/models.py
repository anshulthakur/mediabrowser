...
class Asset(models.Model):
    ...
    uploaded_by = models.CharField(_("uploaded by"), max_length=150, blank=True)
    ...
    def save(self, *args, **kwargs):
        ...
        if request and not self.uploaded_by:
            self.uploaded_by = str(request.user)
        ...
        if resize_to and img:
            img.resize(resize_to, Image.Resampling.LANCZOS).save(self.file.path, img.format)
